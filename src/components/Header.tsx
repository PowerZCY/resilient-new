                ...
                appearance={{
                  elements: {
                    organizationSwitcherTrigger:
                      "relative z-10 px-4 py-3 w-40 h-10 rounded-full text-sm font-medium bg-white text-purple-900 shadow-md border border-gray-200 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition flex items-center justify-between",
